...
public class FieldOfView : MonoBehaviour
{
	...
	public bool checkTargetInFieldOfView;
	...
	protected void FindVisibleTargets()
	{
		...
		checkTargetInFieldOfView = false;
	...
	{
		playerCellRef = playerRef.GetComponent<PlayerManager>().CurrentPlayerCell.VisualDetection;
